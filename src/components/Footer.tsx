    ...
    <footer className="relative w-full text-white pt-2 sm:pt-4 pb-12 overflow-hidden">
      ...
      <div className="w-full bg-gradient-to-b from-[#082245] via-[#051630] to-[#020b1a] rounded-t-[36px] sm:rounded-t-[50px] border-t border-sky-600/30 shadow-2xl relative z-10 px-4 sm:px-8 lg:px-14 pt-14 sm:pt-16 pb-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* 4 Column Grid: Logo/Address, Quick Links, Location & Get Direction, Working Hours Table matching Screenshot 2 */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 text-left mb-12 sm:mb-16">
            
            {/* Column 1: Planet Dental Logo + Address + Bold Phone (lg:col-span-3) */}
            ...
            {/* Column 2: Quick Links (lg:col-span-2) matching Screenshot 2 */}
            <div className="lg:col-span-2 space-y-3">
              <h4 className="text-lg sm:text-xl font-bold text-white tracking-tight">Quick Links</h4>
              <ul className="space-y-2 text-xs sm:text-sm text-gray-300">
                <li>
                  <button 
                    onClick={() => onSelectTab ? onSelectTab('home') : window.scrollTo({ top: 0, behavior: 'smooth' })}
                ...
                <li>
                  <button 
                    onClick={() => onSelectTab ? onSelectTab('about-us') : undefined}
                    className="hover:text-[#38bdf8] transition-colors text-left"
                  >
                    About us
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => onSelectTab ? onSelectTab('orthodontics') : undefined}
                    className="hover:text-[#38bdf8] transition-colors text-left"
                  >
                    Orthodontics
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => onSelectTab ? onSelectTab('implants') : undefined}
                    className="hover:text-[#38bdf8] transition-colors text-left"
                  >
                    Implants
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => onSelectTab ? onSelectTab('faq') : undefined}
                    className="hover:text-[#38bdf8] transition-colors text-left"
                  >
                    FAQ
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => onSelectTab ? onSelectTab('blog') : undefined}
                    className="hover:text-[#38bdf8] transition-colors text-left"
                  >
                    Blogs
                  </button>
                ...
                <li>
                  <button 
                    onClick={() => onSelectTab ? onSelectTab('contact') : undefined}
                    className="hover:text-[#38bdf8] transition-colors text-left font-medium text-white"
                  >
                    Contact Us
                  </button>
                </li>
            ...
            {/* Column 3: Location Heading + Address + Get Direction link (lg:col-span-3) */}
            <div className="lg:col-span-3 space-y-3">
              <h4 className="text-lg sm:text-xl font-bold text-white tracking-tight">Location</h4>
              
              <div className="text-xs sm:text-sm text-gray-300 leading-relaxed">
                <p>250 East Hills Square SE #4110<br />Calgary, AB, Canada T2A 7A7</p>
              </div>
            ...
            {/* Column 4: Working Hours List (lg:col-span-4) */}
            <div className="lg:col-span-4 space-y-3">
              <h4 className="text-lg sm:text-xl font-bold text-white tracking-tight">Working Hours</h4>
