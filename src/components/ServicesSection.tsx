              ...
              <div className="flex flex-col sm:flex-row items-center gap-3">
                {activeModalService.id === 'general' && onNavigateTab && (
                  <>
                    ...
                    >
                      <span>View Hygiene & Cleaning Guide</span>
                      <ChevronRight className="w-4 h-4" />
                    </button>
                    <button
                      onClick={() => {
                        setActiveModalService(null);
                        onNavigateTab('check-up');
                      }}
                      className="w-full sm:w-auto px-5 py-3.5 rounded-full border border-sky-400/40 hover:border-sky-400 bg-sky-500/10 hover:bg-sky-500/20 text-[#38bdf8] font-bold text-sm text-center transition-all cursor-pointer inline-flex items-center justify-center gap-1.5"
                    >
                      <span>View Dental Full Check Up Guide</span>
                      <ChevronRight className="w-4 h-4" />
                    </button>
                    <button
                      onClick={() => {
                ...
                {activeModalService.id === 'cosmetic' && onNavigateTab && (
                  <button
                    onClick={() => {
                      setActiveModalService(null);
                      onNavigateTab('teeth-whitening');
                    }}
                    className="w-full sm:w-auto px-5 py-3.5 rounded-full border border-sky-400/40 hover:border-sky-400 bg-sky-500/10 hover:bg-sky-500/20 text-[#38bdf8] font-bold text-sm text-center transition-all cursor-pointer inline-flex items-center justify-center gap-1.5"
                  >
                    <span>View Teeth Whitening Guide</span>
                    <ChevronRight className="w-4 h-4" />
                  </button>
                )}
                {activeModalService.id === 'implants' && onNavigateTab && (
                  <button
                    onClick={() => {
                      setActiveModalService(null);
                      onNavigateTab('implants');
                    }}
                    className="w-full sm:w-auto px-5 py-3.5 rounded-full border border-sky-400/40 hover:border-sky-400 bg-sky-500/10 hover:bg-sky-500/20 text-[#38bdf8] font-bold text-sm text-center transition-all cursor-pointer inline-flex items-center justify-center gap-1.5"
                  >
                    <span>View Dental Implants Guide</span>
                    <ChevronRight className="w-4 h-4" />
                  </button>
                )}
                {activeModalService.id === 'botox' && onNavigateTab && (
                  <button
                    onClick={() => {
                      setActiveModalService(null);
                      onNavigateTab('custom-night-guards');
                    }}
                    className="w-full sm:w-auto px-5 py-3.5 rounded-full border border-sky-400/40 hover:border-sky-400 bg-sky-500/10 hover:bg-sky-500/20 text-[#38bdf8] font-bold text-sm text-center transition-all cursor-pointer inline-flex items-center justify-center gap-1.5"
                  >
                    <span>View Custom Night Guards Guide</span>
                    <ChevronRight className="w-4 h-4" />
                  </button>
                )}
                {activeModalService.id === 'wisdom-teeth' && onNavigateTab && (
                  <button
                    onClick={() => {
                      setActiveModalService(null);
                      onNavigateTab('sedation-dentistry');
                    }}
                    className="w-full sm:w-auto px-5 py-3.5 rounded-full border border-sky-400/40 hover:border-sky-400 bg-sky-500/10 hover:bg-sky-500/20 text-[#38bdf8] font-bold text-sm text-center transition-all cursor-pointer inline-flex items-center justify-center gap-1.5"
                  >
                    <span>View Sedation Dentistry Guide</span>
                    <ChevronRight className="w-4 h-4" />
                  </button>
                )}
                <button
