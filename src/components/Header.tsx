...
export const Header: React.FC<HeaderProps> = ({ activeTab, onSelectTab, onOpenBooking }) => {
  ...
  const TREATMENT_OPTIONS = [
    ...
    { name: 'Dental Full Check Up', tab: 'check-up' as const },
    { name: 'Hygiene/ Cleaning', tab: 'hygiene' as const },
    { name: 'Dental Implants', tab: 'implants' as const },
    { name: 'Custom Night Guards', tab: 'custom-night-guards' as const },
    { name: 'Sedation Dentistry', tab: 'sedation-dentistry' as const },
    { name: 'Teeth Whitening', tab: 'teeth-whitening' as const },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        ...
        <nav className="hidden md:flex items-center justify-center gap-6 lg:gap-8 pt-3 pb-1 border-t border-gray-800/40 text-[14.5px]">
          ...
          <button
            ...
            className={`font-normal transition-colors cursor-pointer relative py-1 ${
              activeTab === 'implants' || activeTab === 'dental-implants' ? 'text-[#38bdf8] font-medium' : 'text-gray-300 hover:text-white'
            }`}
          >
            <span>Implants</span>
          ...
          <button
            ...
            className={`font-normal transition-colors cursor-pointer relative py-1 ${
              activeTab === 'contact' ? 'text-[#38bdf8] font-medium' : 'text-gray-300 hover:text-white'
            }`}
          >
